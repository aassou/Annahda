				...
				<div class="row-fluid">
					<div class="span12">
						<div class="row-fluid add-portfolio">
							<div class="pull-left">
								<a href="employes-societe.php" class="btn icn-only green"><i class="m-icon-swapleft m-icon-white"></i> Retour vers Liste des employés permanents</a>
							</div>
						</div>
						...
						<div class="tabbable tabbable-custom">
							...
							<div class="tab-content">
													...
													<div class="portlet-body" style="display: block;">
														<table class="table table-striped table-bordered table-advance table-hover">
															...
															<tbody>
																...
																?>
																<tr>
																	<td><a href="#"><?= $salaire->salaire() ?></a></td>
																	<td><a href="#"><?= $salaire->prime() ?></a></td>
																	<td class="hidden-phone"><?= $salaire->dateOperation() ?></td>
																	<td>
																...
																<div id="updateSalaireEmploye<?= $salaire->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
																	...
																	<div class="modal-body">
																		<form class="form-horizontal" action="../controller/EmployeSocieteSalaireUpdateController.php" method="post" enctype="multipart/form-data">
																			...
																			<div class="control-group">
																				...
																				<div class="controls">
																					<input type="text" name="prime" value="<?= $salaire->prime() ?>" />
																				</div>
																			</div>	
																			<div class="control-group">
																...
																<div id="deleteSalaireEmploye<?= $salaire->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
																	...
																	<div class="modal-body">
																		<form class="form-horizontal loginFrm" action="../controller/EmployeSocieteSalaireDeleteController.php" method="post">
														...
														<a class="btn big blue">Total : <?= $salairesManager->getTotalByIdEmploye($idEmploye) ?></a>
													</div>
												</div>
												<!--tab-pane-->
														...
														<table class="table table-striped table-bordered table-advance table-hover">
															...
															<tbody>
																...
																<div id="updateCongeEmploye<?= $conge->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
																	...
																	<div class="modal-body">
																		<form class="form-horizontal" action="controller/EmployeSocieteCongeUpdateController.php" method="post" enctype="multipart/form-data">
																...
																<div id="deleteCongeEmploye<?= $conge->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
																	...
																	<div class="modal-body">
																		<form class="form-horizontal loginFrm" action="controller/EmployeSocieteCongeDeleteController.php" method="post">
								...
								<div id="updateEmploye<?= $employe->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
									...
									<div class="modal-body">
										<form class="form-horizontal" action="../controller/EmployeSocieteUpdateController.php?param=2" method="post" enctype="multipart/form-data">
								...
								<div id="addSalaireEmploye<?= $employe->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
									...
									<div class="modal-body">
										<form class="form-horizontal" action="../controller/EmployeSocieteSalaireAddController.php" method="post" enctype="multipart/form-data">
											...
											<div class="control-group">
												<label class="control-label">Prime</label>
												<div class="controls">
													<input type="text" name="prime" value="0" />
												</div>
											</div>	
											<div class="control-group">
												<label class="control-label">Date opération</label>
								...
								<div id="addCongeEmploye<?= $employe->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
									...
									<div class="modal-body">
										<form class="form-horizontal" action="controller/EmployeSocieteCongeAddController.php" method="post" enctype="multipart/form-data">
