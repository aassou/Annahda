...
//classes loading begin
    ...
    if(isset($_SESSION['userMerlaTrav'])){
        ...
        $contrats = $contratManager->getContratsByIdClient($idClient);
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <i class="icon-user"></i>
                                <a href="clients-synthese.php">Synthèse des clients</a>
                                <i class="icon-angle-right"></i>
                            </li>
                            <li>
                                <i class="icon-copy"></i>
                                <a><strong>Liste des contrats <?= ucfirst($client->nom()) ?></strong></a>
                            </li>
                        </ul>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            ...
                                                            if( $_SESSION['userMerlaTrav']->profil() == "admin" ){ 
                                                                ...
                                                                ?>  
                                                                <a href="#1111activerContrat<?= $contrat->id() ?>" data-toggle="modal" data-id="<?= $contrat->id() ?>">
                                                                    <!-- Activer -->
                                                                </a>    
                                                                <?php   
                                                                ...
                                                                ?>
                                                                <a style="color:red" href="#1111updateRevendre<?= $contrat->id() ?>" data-toggle="modal" data-id="<?= $contrat->id() ?>">
                                                                    <!-- Revendre -->
                                                                </a>
                                                                <?php 
                                                                }    
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal loginFrm" action="../controller/ContratArabePrintController.php?idContrat=<?= $contrat->id() ?>" method="post">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <input type="hidden" name="idProjet" value="<?php //$projet->id() ?>" />
