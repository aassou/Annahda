                ...
                <div class="row-fluid">
                    <div class="span12">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a><strong>Liste des contrats désistés</strong></a>
                            </li>
                        </ul>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box light-grey">
                            ...
                            <div class="portlet-body">
                                <div class="clearfix">
                                    <div class="btn-group">
                                        <a target="_blank" class="btn blue pull-right" href="../controller/ClientsDesistesSituationsPrintController.php?idProjet=<?= $projet->id() ?>">
