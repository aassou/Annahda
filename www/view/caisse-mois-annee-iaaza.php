                    ...
                    <div class="span12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="caisse-group-iaaza.php">Gestion de la caisse <strong>Société MarocInvest2AS</strong></a>
                                <i class="icon-angle-right"></i>
                            </li>
                            <li>
                                ...
                                <div class="modal-footer">
                                    <div class="control-group">
                                        <div class="controls">  
                                            ...
                                            <input type="hidden" name="source" value="caisse-mois-annee-iaaza" />
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="hidden-phone">
                                                ...
                                                <a title="Bon de Commande" class="btn mini blue" href="../controller/CaisseIaazaBonPrintController.php?idCaisse=<?= $caisse->id() ?>" target="_blank"><i class="icon-print"></i></a>
                                            </td>
                                            <?php
                                            }
                                            ?>
                                        ...
                                        <div id="updateCaisse<?= $caisse->id() ?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                            ...
                                            <div class="modal-body">
                                                <form id="addCaisseForm" action="../controller/CaisseIaazaActionController.php" method="post">
                                                    <div class="control-group">
                                                        <label class="control-label">Type Opération</label>
                                                        <div class="controls">
                                                            <select name="type">
                                        ...
                                        <div id="deleteCaisse<?= $caisse->id() ?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal loginFrm" action="../controller/CaisseIaazaActionController.php" method="post">
