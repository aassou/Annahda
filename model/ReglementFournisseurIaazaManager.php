<?php
class ReglementFournisseurIaazaManager{
    //attributes
    private $_db;
    ...
    public function add(ReglementFournisseur $reglementFournisseur){
        $query = $this->_db->prepare('INSERT INTO t_reglement_fournisseur_iaaza 
    ...
    public function update(ReglementFournisseur $reglementFournisseur){
        ...
        'UPDATE t_reglement_fournisseur_iaaza SET dateReglement=:dateReglement, idFournisseur=:idFournisseur,
        idProjet=:idProjet, montant=:montant, modePaiement=:modePaiement, numeroCheque=:numeroCheque, 
        updated=:updated, updatedBy=:updatedBy WHERE id=:id') 
        or die(print_r($this->_db->errorInfo()));
	...
	public function updateNumeroCheque($numeroCheque, $idReglement){
        $query = $this->_db->prepare('UPDATE t_reglement_fournisseur_iaaza SET numeroCheque=:numeroCheque WHERE id=:id') 
        or die(print_r($this->_db->errorInfo()));
	...
	public function delete($idReglementFournisseur){
        $query = $this->_db->prepare('DELETE FROM t_reglement_fournisseur_iaaza WHERE id=:id') 
        or die(print_r($this->_db->errorInfo()));
    ...
    public function getReglementFournisseursByIdFournisseur($idFournisseur){
        ...
        $query = $this->_db->prepare('SELECT * FROM t_reglement_fournisseur_iaaza WHERE idFournisseur=:idFournisseur 
        ORDER BY id DESC');
	...
	public function getReglementFournisseursByIdProjet($idProjet){
        $reglementFournisseurs = array();
        $query = $this->_db->prepare('SELECT * FROM t_reglement_fournisseur_iaaza WHERE idProjet=:idProjet 
	...
	public function sommeReglementFournisseurByIdProjetAndIdFournisseur($idProjet, $idFournisseur){
        $query = $this->_db->prepare('SELECT SUM(montant) AS total FROM t_reglement_fournisseur_iaaza 
    ...
    public function sommeReglementFournisseursByIdFournisseur($idFournisseur){
        ...
        FROM t_reglement_fournisseur_iaaza WHERE idFournisseur =:idFournisseur');
        $query->bindValue('idFournisseur', $idFournisseur);
        $query->execute();
        $data = $query->fetch(PDO::FETCH_ASSOC);
        $query->closeCursor();
    ...
    public function getLastId(){
        $query = $this->_db->query('SELECT id AS last_id FROM t_reglement_fournisseur_iaaza ORDER BY id DESC LIMIT 0, 1');
        $data = $query->fetch(PDO::FETCH_ASSOC);
        $id = $data['last_id'];
        return $id;
    }
    ...
    public function getReglementFournisseurById($id){
        $query = $this->_db->prepare('SELECT * FROM t_reglement_fournisseur_iaaza WHERE id =:id');
	...
	public function getReglementNumberTous($idProjet){
        ...
        FROM t_reglement_fournisseur_iaaza WHERE idProjet =:idProjet');
        $query->bindValue(':idProjet', $idProjet);
        $query->execute();
        $data = $query->fetch(PDO::FETCH_ASSOC);
        $query->closeCursor();
	...
	public function getReglementsNumberByIdFournisseurByIdProjet($idProjet, $idFournisseur){
        $query = $this->_db->prepare('SELECT count(id) AS nombreReglements 
        FROM t_reglement_fournisseur_iaaza WHERE idProjet =:idProjet AND idFournisseur=:idFournisseur');
        $query->bindValue(':idProjet', $idProjet);
		$query->bindValue(':idFournisseur', $idFournisseur);
        $query->execute();
        $data = $query->fetch(PDO::FETCH_ASSOC);
	...
	public function getIdFournisseurs($idProjet){
		...
		$query = $this->_db->prepare('SELECT DISTINCT idFournisseur FROM t_reglement_fournisseur_iaaza WHERE idProjet=:idProjet');
		$query->bindValue(':idProjet', $idProjet);
        $query->execute();
        while($data = $query->fetch(PDO::FETCH_ASSOC)){
	...
	public function getTotalReglementTous($idProjet){
        $query = $this->_db->prepare('SELECT SUM(montant) AS total FROM t_reglement_fournisseur_iaaza WHERE idProjet=:idProjet');
        $query->bindValue(':idProjet', $idProjet);
        $query->execute();
        $data = $query->fetch(PDO::FETCH_ASSOC);
        $query->closeCursor();
	...
	public function getTotalReglementByIdFournisseur($idFournisseur){
        $query = $this->_db->prepare('SELECT SUM(montant) AS total FROM t_reglement_fournisseur_iaaza WHERE 
	...
	public function getTotalReglement(){
        $query = $this->_db->query('SELECT SUM(montant) AS total FROM t_reglement_fournisseur_iaaza');
        $data = $query->fetch(PDO::FETCH_ASSOC);
        $query->closeCursor();
        return $data['total'];
	}
	...
	public function sommeReglementFournisseursByIdFournisseurByProjet($idFournisseur, $idProjet){
        ...
        FROM t_reglement_fournisseur_iaaza WHERE idFournisseur =:idFournisseur AND idProjet=:idProjet');
        $query->bindValue(':idFournisseur', $idFournisseur);
		$query->bindValue(':idProjet', $idProjet);
        $query->execute();
        $data = $query->fetch(PDO::FETCH_ASSOC);
     ...
     ************************************************************************************************/
     ...
     public function sommeReglementFournisseursByIdFournisseurByDates($idFournisseur, $dateFrom, $dateTo){
        $query = $this->_db->prepare(
        'SELECT SUM(montant) AS total FROM t_reglement_fournisseur_iaaza 
