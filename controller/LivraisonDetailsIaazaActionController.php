<?php
    ...
    if($action == "add"){
        if( !empty($_POST['prixUnitaire']) and !empty($_POST['quantite']) ){
            ...
            //create object
            $livraisonDetail = 
            new LivraisonDetailIaaza(array('prixUnitaire' => $prixUnitaire, 'quantite' => $quantite,
    ...
    //Action Update Processing Begin
        ...
        if( !empty($_POST['prixUnitaire']) and !empty($_POST['quantite']) ){
            ...
            $livraisonDetail = 
            new LivraisonDetailIaaza(array('id' => $idLivraisonDetail, 'designation' => $designation,
            ...
            $history = new History(array(
                'action' => "Modification",
                'target' => "Table des détails livraisons",
                'description' => "Modification de l'article ".$idLivraisonDetail." - Société : Iaaza",
                'created' => $created,
                'createdBy' => $createdBy
            ));
            //add it to db
    ...
    //Action Delete Processing Begin
        ...
        $history = new History(array(
            'action' => "Suppression",
            'target' => "Table des détails livraisons",
            'description' => "Suppression de l'article ".$idLivraisonDetail." - Société : Iaaza",
            'created' => $created,
            'createdBy' => $createdBy
        ));
        //add it to db
