<?php
    ...
    if($action == "add"){
        if( !empty($_POST['numeroCommande']) ){
            ...
            $typeMessage = "success";
            $redirectLink = "Location:../commande-details.php?codeCommande=".$codeLivraison."&mois=".$mois."&annee=".$annee;
        }
        else{
            if ( isset($_POST['source']) and $_POST['source'] == "commande-group-iaaza" ) {
                $redirectLink = "Location:../commande-group.php";
            } 
    ...
    //Action Update Processing Begin
        ...
        if ( isset($_POST['source']) and $_POST['source'] == "commande-mois-annee-iaaza" ) {
            $redirectLink = "Location:../commande-mois-annee.php?mois=".$mois."&annee=".$annee;
        }
