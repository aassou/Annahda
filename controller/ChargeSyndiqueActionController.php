<?php
    ...
    if($action == "add"){
        if( !empty($_POST['type']) ){
            ...
            $typeCharge = $typeChargeManager->getTypeChargeSyndiqueById($type)->nom();
            ...
            //create object
            $charge = new ChargeSyndique(array(
                'type' => $type,
    ...
    //Action Delete Processing Begin
        ...
        $idCharge = htmlentities($_POST['idCharge']);
        $charge = $chargeManager->getChargeSyndiqueById($idCharge);
        $typeCharge = $typeChargeManager->getTypeChargeSyndiqueById($charge->type())->nom();
