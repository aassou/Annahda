...
$pdf->WriteHTML($htmlcontent, true, 0, true, 0);
$htmlcontent = 'يقر الطرف الأول انه يحفظ حق الطرف الثاني في شراء '.$typeBien.' و '.$cave.' .في مشروعه السكني المسمى ب النهضة ...... الكائن بإقليم
...
//Acte 3 : Details
    ...
    $pdf->WriteHTML($htmlcontent, true, 0, true, 0);
    //Detail 5:
    $htmlcontent = '5.وضعية ال'.$typeBien.' وفق الاتفاق  : تسليم ال'.$typeBien.' في وضعية الأشغال النهائية  للبناء أو الاساسية للبناء.';
    $pdf->WriteHTML($htmlcontent, true, 0, true, 0);
    //Detail 6:
...
$pdf->WriteHTML($htmlcontent, true, 0, true, 0);
$htmlcontent = 'اتفق الطرفان على تحديد الثمن النهائي لبيع ال'.$typeBien.' '.$cave.' في مبلغ   درهم '.$montant.'(......................... درهم). يؤديها الطرف الثاني للطرف الأول على شكل أقساط ابتدءا من قسط التسبيق إلى تاريخ انتهاء الأشغال المتعلقة بتسليم ال'.$typeBien.' وذلك حسب الدفعات المبينة في الجدول المرفق .';
$pdf->WriteHTML($htmlcontent, true, 0, true, 0);
$pdf->Ln();
//Acte 6:
