...
$pdf->WriteHTML($htmlcontent, true, 0, true, 0);
$pdf->Ln();
$htmlcontent = 'ينهي خلالها الطرف الثاني جميع اﻷشغال المتعلقة بهذا التعاقد وفق المواصفات و الجودة المحددة في هذا العقد و في حالة عدم احترامه للمدة فإنه يؤدي تعويضها يقدر حسب الضرر الناجم عن تأخر إنجاز اﻷشغال المذكورة بعد انتداب أحد الخبراء المتخصصين يختاره الطرفان بالتراضي أو يعين قضائيا مع التزام الطرف الثاني بأداء أتباعه و التزام الطرف اﻷول بإرجاعها في حالة ثبوت عدم وجود أي خلل في المدة أو المواصفات و الجودة.';
$pdf->WriteHTML($htmlcontent, true, 0, true, 0);
$pdf->Ln();
//Acte 5:
