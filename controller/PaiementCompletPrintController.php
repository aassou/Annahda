...
$pdf->Ln();
$pdf->Ln();
$htmlcontent = ' تشهد شركة : '.$company->nomArabe().'، ش .م .م  في شخص ممثلها القانوني, و الكائن مقرها الاجتماعي ب'.$company->adresseArabe().' بأن السيد(ة) '.$client->nomArabe().' قد أدى (ت) ما بذمتها تجاه الشركة المذكورة أعلاه و المتمثل في القيمة المالية التي مجموعها '.number_format($contrat->prixVente(), 2, ',', '').' درهم (...............................................................................درهم)   ';
