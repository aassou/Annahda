    ...
    if($action == "add"){
        ...
        if(!empty($_POST['libelle'])){
            ...
            $history = new History(array(
                'action' => "Modification",
                'target' => "Table des livraisons",
                'description' => "Modification de la livraison, libelle : ".$libelle.", fournisseur : ".$nomFournisseur." - Projet : ".$nomProjet." - "."Société : Iaaza",
                'created' => $created,
                'createdBy' => $createdBy
            ));
            //add it to db
        ...
        $history = new History(array(
            ...
            'description' => "Suppression de la livraison ".$idLivraison." ainsi que ses détails"." - Société : Iaaza",
            'created' => $created,
            'createdBy' => $createdBy
        ));
        //add it to db
