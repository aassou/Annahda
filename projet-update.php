                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a>Modifier Projet <strong><?= $nomProjet ?></strong></a></li>
                        </ul>
                        ...
                        <div class="tab-pane active" id="tab_1">
                           <div class="portlet box grey">
                              <div class="portlet-title">
                                 <h4><i class="icon-edit"></i>Modifier Projet <?= $nomProjet ?></h4>
                                 <div class="tools">
                              ...
                              <div class="portlet-body form">
                                 ...
                                 <form id="updateProjetForm" action="controller/ProjetActionController.php" method="POST" class="horizontal-form">
                                    <div class="row-fluid">
                                        <div class="span3">
                                           <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="nomArabe" name="nomArabe" class="m-wrap span12" value="<?= $projet->nomArabe() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                           <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="adresseArabe" name="adresseArabe" class="m-wrap span12" value="<?= $projet->adresseArabe() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                           <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" name="nom" class="m-wrap span12" value="<?= $projet->nom() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                    ...
                                    <div class="row-fluid">
                                       ...
                                       <div class="span3">
                                           <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="numeroLot" name="numeroLot" class="m-wrap span12" value="<?= $projet->numeroLot() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                           <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="numeroAutorisation" name="numeroAutorisation" class="m-wrap span12" value="<?= $projet->numeroAutorisation() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
                                       ...
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="nombreEtages" name="nombreEtages" class="m-wrap span12" value="<?= $projet->nombreEtages() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="sousSol" name="sousSol" class="m-wrap span12" value="<?= $projet->sousSol() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="rezDeChausser" name="rezDeChausser" class="m-wrap span12" value="<?= $projet->rezDeChausser() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="mezzanin" name="mezzanin" class="m-wrap span12" value="<?= $projet->mezzanin() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                           <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="cageEscalier" name="cageEscalier" class="m-wrap span12" value="<?= $projet->cageEscalier() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                           <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="terrase" name="terrase" class="m-wrap span12" value="<?= $projet->terrase() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="superficieEtages" name="superficieEtages" class="m-wrap span12" value="<?= $projet->superficieEtages() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="delai" name="delai" class="m-wrap span12" value="<?= $projet->delai() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="prixParMetreHT" name="prixParMetreHT" class="m-wrap span12" value="<?= $projet->prixParMetreHT() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="TVA" name="TVA" class="m-wrap span12" value="<?= $projet->TVA() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                               ...
                                               <div class="controls">
                                                   <input type="text" id="prixParMetreTTC" name="prixParMetreTTC" class="m-wrap span12" value="<?= $projet->prixParMetreTTC() ?>" />
                                               </div>
                                           </div>
                                       </div>
                                    </div>
                                    <div class="row-fluid">
                                       <div class="span3">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <textarea style="width:270px;" name="adresse" class="m-wrap span12" rows="3"><?= $projet->adresse() ?></textarea>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <textarea style="width:270px;" name="description" class="m-wrap span12" rows="3"><?= $projet->description() ?></textarea>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <textarea style="width:270px;" id="architecte" name="architecte" class="m-wrap span12" rows="3"><?= $projet->architecte() ?></textarea>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <textarea style="width:270px;" id="bet" name="bet" class="m-wrap span12" rows="3"><?= $projet->bet() ?></textarea>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-actions">
                                        ...
                                        <button type="submit" class="btn black">Modifier <i class="icon-refresh"></i></button>
                                    </div>
                                 </form>
                                 <!-- END FORM--> 
                              </div>
