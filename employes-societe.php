			...
			<div class="container-fluid">
						...
						<div class="tab-pane active" id="tab_1">
                           ...
                           <div class="portlet box grey">
                              ...
                              <div class="portlet-body form">
                                 <!-- BEGIN FORM-->
                                 <form action="controller/EmployeSocieteAddController.php" method="POST" class="horizontal-form" enctype="multipart/form-data">
                                    <div class="row-fluid">
                                       <div class="span4 ">
				...
				<div class="row-fluid"> 
					<div class="span12">
						...
						<div class="portlet">
							<div class="portlet-title">
								<h4>Liste des employés permanents</h4>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="javascript:;" class="remove"></a>
								</div>
							...
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-advance table-hover">
									...
									<tbody>
										<?php
										if($employeNumber != 0){
										foreach($employesSociete as $employe){
										?>		
										<tr>
											<td><a href="employe-societe-profile.php?idEmploye=<?= $employe->id() ?>"><?= $employe->nom() ?></a></td>
										...
										<div id="updateEmploye<?= $employe->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
											...
											<div class="modal-body">
												<form class="form-horizontal" action="controller/EmployeSocieteUpdateController.php?param=1" method="post" enctype="multipart/form-data">
										...
										<div id="deleteEmploye<?= $employe->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
											...
											<div class="modal-body">
												<form class="form-horizontal loginFrm" action="controller/EmployeSocieteDeleteController.php" method="post">
